...
namespace SIBKMNET_WebApp.Repositories.Data
{
    public class AccountRepository
    {
        ...
        public ResponseLogin Login(Login login)
        {
            ...
            var verify = Hashing.ValidataPassword(login.Password, data.User.Password);
            if (verify)
            {
    ...
    // Change Password
        public int ChangePass(int Id, ChangePass changePass)
        {
            ...
            var verify = Hashing.ValidataPassword(changePass.PassLama, data.User.Password);
            if (verify)
            {
